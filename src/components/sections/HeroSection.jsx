        ...
        <div className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex gap-2">
                    ...
                    {[
                        { Icon: Github, color: "text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white", href: "#" },
                        { Icon: Linkedin, color: "text-gray-600 dark:text-gray-400 hover:text-blue-500", href: "#" },
                        { Icon: Mail, color: "text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white", href: "mailto:zhnuksyh03@gmail.com" },
                        { Icon: ChessPawn, color: "text-gray-600 dark:text-gray-400 hover:text-green-600", href: "#" }
                    ].map(({ Icon, color, href }, i) => (
                        <a key={i} href={href} className={`flex items-center justify-center w-11 h-11 transition-colors bg-white dark:bg-[#202020] border border-gray-100 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-600 rounded-lg ${color}`}>
