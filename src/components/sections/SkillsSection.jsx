...
const SkillIcon = ({ name, url, hoverUrl }) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center p-4 rounded-xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-[#202020] hover:border-gray-300 dark:hover:border-gray-600 transition-all hover:shadow-lg dark:hover:shadow-black/50 group w-full aspect-square">
            <div className="w-10 h-10 mb-3 flex items-center justify-center rounded-lg bg-gray-50 dark:bg-[#252525] group-hover:bg-white dark:group-hover:bg-[#303030] transition-colors relative p-2">
                ...
                {hoverUrl ? (
                    ...
                    <>
                        ...
                        <img
                            src={url}
                            alt={name}
                            className="w-full h-full object-contain transition-all duration-300 filter grayscale group-hover:opacity-0 opacity-40 dark:invert"
                        />
                    </>
                ) : isLocal ? (
                    ...
                    <img
                        src={url}
                        alt={name}
                        className="w-full h-full object-contain transition-all duration-300 filter grayscale group-hover:grayscale-0 group-hover:opacity-100 group-hover:brightness-100 dark:group-hover:invert-0 opacity-40 dark:invert"
                    />
                ) : (
                    ...
                    <>
                        ...
                        <img
                            ...
                            alt={name}
                            className="w-full h-full object-contain filter grayscale-[100%] group-hover:opacity-0 transition-all duration-300 opacity-40"
                        />
                    </>
                )}
            </div>
